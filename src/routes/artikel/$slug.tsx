        ...
        <main className="flex-1 w-full mx-auto max-w-2xl px-5 sm:px-8 py-8">
          ...
          <article className="mt-4">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              {formatDateId(article.datePublished)} · {article.readMins} menit baca
            </p>
            <div className="mt-2">{article.body()}</div>
          </article>

          <div className="mt-12 rounded-2xl border border-border bg-card p-6 text-center">
            <p className="font-serif text-xl text-foreground">Siap mencoba sendiri?</p>
            <p className="mt-1 text-sm text-muted-foreground">
              Generate semua variasi titik Gmail kamu - gratis, privat, di browser.
            </p>
