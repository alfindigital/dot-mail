  ...
  head: () => ({
    meta: [
      ...
      { title: "DotMail — Gmail Dot Trick Generator" },
      {
        name: "description",
        content:
          "Generate semua variasi titik pada alamat Gmail kamu. Cepat, elegan, sepenuhnya berjalan di browser.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "DotMail — Gmail Dot Trick Generator" },
      { name: "twitter:title", content: "DotMail — Gmail Dot Trick Generator" },
      { name: "description", content: "Generates all Gmail dot variations for a given username, aiding in email management." },
      { property: "og:description", content: "Generates all Gmail dot variations for a given username, aiding in email management." },
      { name: "twitter:description", content: "Generates all Gmail dot variations for a given username, aiding in email management." },
